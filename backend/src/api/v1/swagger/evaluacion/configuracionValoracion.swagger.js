...
/**
 * @swagger
 * /configuracion-valoracion/{id}/estado:
 *   patch:
 *     summary: Actualizar el estado (activo/inactivo) de una configuración de valoración
 *     tags: [Configuración Valoración]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *               activo:
 *                 type: boolean
 *                 description: Nuevo estado de la configuración de valoración
 *                 example: false
 *     responses:
 *       200:
